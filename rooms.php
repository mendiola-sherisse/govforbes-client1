...
<head>
    ...
    <title>Governor Forbes Inn | Rooms</title>
            ...
            <div class="room-card-horizontal">
                <div class="room-img">
                    <img src="images/rooms/<?= $room['RoomTypeID']; ?>.jpg"
                        ...
                        onerror="this.onerror=null; this.src='images/rooms/default.jpg';">
                </div>
                <div class="room-info">
                    ...
                    <button onclick="location.href='checkout.php'">Book Now</button>
                </div>
            </div>
        <?php endwhile; ?>
    </section>
